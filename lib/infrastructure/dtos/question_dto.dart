...
class QuestionDto {
  ...
  final String type; // raw API string
  final int timeLimit;
  final int points;
  ...
  /// Produce request JSON according to API spec (questionText, questionType, answers.answerText)
  Map<String, dynamic> toJson() => {
        if (id != null) 'id': id,
        if (quizId != null) 'quizId': quizId,
        'questionText': text,
        'mediaId': mediaId,
        // use 'questionType' key in requests
        'questionType': type,
        'timeLimit': timeLimit,
        'points': points,
