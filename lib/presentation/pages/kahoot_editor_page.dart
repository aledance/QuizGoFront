              ...
              children: [
                Padding(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () => _controller.addQuestion(),
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () => _controller.removeQuestion(index),
                        ),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: const Icon(Icons.photo_camera, size: 32, color: Colors.grey),
                          ),
                        ),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Icon(
                                          a.isCorrect ? Icons.radio_button_checked : Icons.radio_button_off,
                                          color: a.isCorrect ? Theme.of(context).primaryColor : Colors.grey,
                                        ),
                                      ),
                                    ],
                                  ),
                                ...
                                ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    try {
                                      ...
                                      // Optionally navigate or populate editor with created
