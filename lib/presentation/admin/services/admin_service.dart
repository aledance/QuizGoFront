...
class AdminService {
  ...
  Future<Map<String, dynamic>> getUsers({int page = 1, int limit = 20, String? search, String? role, String? orderBy, String? order, String? status}) => _repo.getUsers(page: page, limit: limit, search: search, role: role, orderBy: orderBy, order: order, status: status);
