...
class _AdminDashboardPageState extends State<AdminDashboardPage> {
  ...
  void initState() {
    ...
    _controller = MetricsController(service: AdminService(baseUrl: baseUrl));
                ...
                child: Column(
                  ...
                  if (_controller.error != null)
                    Padding(
                      ...
                      child: Text('Error: ${_controller.error}', style: const TextStyle(color: Colors.red)),
                    ),
                ],
                ),
              ),
